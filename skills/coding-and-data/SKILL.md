...
**MANDATORY: Use run_subagent with subagent_type="codebase" for Snowflake / data warehouse analysis, but ONLY when the user has a Snowflake connector.**
